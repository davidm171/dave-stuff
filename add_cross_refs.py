...
def crossRefs(lang, build_path, htm_object_list, htm_italics_list):
    ...
    for italics_object in htm_italics_list:
        fileText = openFile(italics_object.htm_path)
        findItalics = italics_object.italics_list
        print "\nThe file is: ", italics_object.htm_path
        if "system_parameters" not in str(italics_object.htm_path):  # Don't process the system parameters directory
            if findItalics:
        ...
        writefile(italics_object.htm_path, fileText)
