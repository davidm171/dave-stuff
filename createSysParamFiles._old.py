...
def create_parameter_files(lang, build_path, allHtmPaths):
    ...
    def findHtm(path):
        ...
        return htmfiles
    # -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    def filePaths(allHtmPaths,systemParameterFileList):
        systemParameterFilePaths = []
        for htmPath in allHtmPaths:
            if os.allHtmPaths.split(htmPath)[1] in systemParameterFileList:
...
if __name__ == '__main__':
    ...
    subsystemsDir = r"C:\test_project\output\AdvantageHTML5_us\Subsystems" # This is also declared in the htm info object
